...
public class LeafQueueWithCapacityTest {
    ...
    private static final Log LOG = LogFactory.getLog(LeafQueueWithCapacityTest.class);
    ...
    public void testUserQueueAcl() throws Exception {
        ...
        FiCaSchedulerApp app_0 = new FiCaSchedulerAppWithCapacity(appAttemptId_0, user_d, d, null,
                rmContext);
        ...
        FiCaSchedulerApp app_1 = new FiCaSchedulerAppWithCapacity(appAttemptId_1, user_d, d, null,
                rmContext);
    ...
    public void testAppAttemptMetrics() throws Exception {
        ...
        // Submit applications
        final ApplicationAttemptId appAttemptId_0 = TestUtils.getMockApplicationAttemptId(0, 1);
        FiCaSchedulerApp app_0 = new FiCaSchedulerAppWithCapacity(appAttemptId_0, user_0, a, null,
                rmContext);
        a.submitApplication(app_0, user_0, B);
        ...
        // Attempt the same application again
        final ApplicationAttemptId appAttemptId_1 = TestUtils.getMockApplicationAttemptId(0, 2);
        FiCaSchedulerApp app_1 = new FiCaSchedulerAppWithCapacity(appAttemptId_1, user_0, a, null,
                rmContext);
        a.submitApplication(app_1, user_0, B); // same user
    ...
    public void testUserLimits() throws Exception {
        ...
        FiCaSchedulerApp app_2 =
                new FiCaSchedulerAppWithCapacity(appAttemptId_2, user_1, a,
                a.getActiveUsersManager(), rmContext);
...
//            recordFactory))); 
    ...
    public void testSingleQueueWithMultipleUsers() throws Exception {
        ...
        FiCaSchedulerApp app_3 =
                new FiCaSchedulerAppWithCapacity(appAttemptId_3, user_2, a,
                a.getActiveUsersManager(), rmContext);
    ...
    public void testReservation() throws Exception {
        ...
        final ApplicationAttemptId appAttemptId_1 =
                TestUtils.getMockApplicationAttemptId(1, 0);
        FiCaSchedulerApp app_1 =
                new FiCaSchedulerAppWithCapacity(appAttemptId_1, user_1, a,
                mock(ActiveUsersManager.class), rmContext);
    ...
    public void testStolenReservedContainer() throws Exception {
        LOG.info("--- START: testStolenReservedContainer ---");
        // Manipulate queue 'a'
        LeafQueue a = stubLeafQueue((LeafQueue) queues.get(A));
        //unset maxCapacity
        a.setMaxCapacity(1.0f);
    ...
    public void testLocalityScheduling() throws Exception {
        LOG.info("--- START: testLocalityScheduling ---");
        // Manipulate queue 'a'
        LeafQueue a = stubLeafQueue((LeafQueue) queues.get(A));
        ...
        final ApplicationAttemptId appAttemptId_0 =
                TestUtils.getMockApplicationAttemptId(0, 0);
        FiCaSchedulerApp app_0 =
                spy(new FiCaSchedulerAppWithCapacity(appAttemptId_0, user_0, a,
                mock(ActiveUsersManager.class), rmContext));
        a.submitApplication(app_0, user_0, A);
    ...
    public void testActivateApplicationAfterQueueRefresh() throws Exception {
        ...
        final ApplicationAttemptId appAttemptId_0 =
                TestUtils.getMockApplicationAttemptId(0, 0);
        FiCaSchedulerApp app_0 =
                new FiCaSchedulerAppWithCapacity(appAttemptId_0, user_e, e,
                mock(ActiveUsersManager.class), rmContext);
        ...
        final ApplicationAttemptId appAttemptId_1 =
                TestUtils.getMockApplicationAttemptId(1, 0);
        FiCaSchedulerApp app_1 =
                new FiCaSchedulerAppWithCapacity(appAttemptId_1, user_e, e,
                mock(ActiveUsersManager.class), rmContext);
        ...
        final ApplicationAttemptId appAttemptId_2 =
                TestUtils.getMockApplicationAttemptId(2, 0);
        FiCaSchedulerApp app_2 =
                new FiCaSchedulerAppWithCapacity(appAttemptId_2, user_e, e,
                mock(ActiveUsersManager.class), rmContext);
        ...
        csConf.setDouble(CapacitySchedulerConfiguration.MAXIMUM_APPLICATION_MASTERS_RESOURCE_PERCENT,
                CapacitySchedulerConfiguration.DEFAULT_MAXIMUM_APPLICATIONMASTERS_RESOURCE_PERCENT * 2);
    ...
    public void testLocalityConstraints() throws Exception {
        ...
        final ApplicationAttemptId appAttemptId_1 =
                TestUtils.getMockApplicationAttemptId(1, 0);
        FiCaSchedulerApp app_1 =
                spy(new FiCaSchedulerAppWithCapacity(appAttemptId_1, user_0, a,
                mock(ActiveUsersManager.class), rmContext));
